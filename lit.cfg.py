"""
LLVM lit configuration for RISC-V Linux roundtrip tests.

This configuration sets up the test environment for running boot and benchmark
tests on MIPS RISC-V CPUs via QEMU.
"""
...
# Directory where tests are executed (can be same as source)
